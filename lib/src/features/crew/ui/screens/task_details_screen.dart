                  ...
                  itemBuilder: (context, index) {
                    return CartItem(
                      ...
                      name: widget.arguments.order.cart![index].package == null
                          ? isArabic
                              ? widget
                                  .arguments.order.cart![index].item!.nameAr!
                              : widget
                                  .arguments.order.cart![index].item!.nameEn!
                          : isArabic
                              ? widget
                                  .arguments.order.cart![index].package!.nameAr!
                              : widget.arguments.order.cart![index].package!
                                  .nameEn!,
                      count:
                          widget.arguments.order.cart![index].count.toString(),
                      price:
                          widget.arguments.order.cart![index].price.toString(),
                      onDelete: () {},
                    );
                  },
                ),
